/**
 * Joins a room using the provided parameters to consume media.
 *
 ...
 * @returns {Promise<object>} - A Promise that resolves with the data received from the 'joinConRoom' event.
 */
...
export async function joinConRoom(socket, roomName, islevel, member, sec, apiUserName) {
